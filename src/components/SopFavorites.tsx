    ...
    <div className="flex-1 overflow-y-auto px-6 py-6 flex flex-col justify-start bg-slate-50/30">
      <div className="max-w-4xl mx-auto w-full space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm text-left relative overflow-hidden">
          <div className="absolute top-0 right-0 h-full w-24 bg-gradient-to-l from-rose-500/5 to-transparent pointer-events-none" />
          <div className="flex items-center space-x-2 text-rose-600 mb-1">
            <Heart className="w-5 h-5 fill-current" />
            <h2 className="text-base font-black tracking-wide font-sans">
              FAVORITE PROCEDURES
            </h2>
          </div>
            ...
            favoriteSops.map((sop) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative bg-white rounded-2xl border border-slate-200 p-5 text-left transition-all shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4"
                >
                  <div className="flex-1 space-y-2">
                    ...
                    <div className="text-[10px] font-mono text-slate-450 flex items-center space-x-2">
                  ...
                  <div className="shrink-0 flex items-center space-x-2 justify-end">
                    {/* Delete Icon */}
                    <button
                    ...
                    <button
                      ...
                      className="flex items-center space-x-1.5 px-4 py-2.5 bg-slate-950 hover:bg-slate-900 text-white rounded-xl font-extrabold text-xs shadow-sm transition-all focus:outline-none cursor-pointer"
                    >
